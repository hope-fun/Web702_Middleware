...
(function() {
	...
	g.prototype = {
		...
		setRankingLevelScoreDesc : function(a, b, c) {
			this.setRanking(this.rankingType.RANKING_TYPE_LEVEL_SCORE_DESC, a,
					b, c)
		},
		setRankingLevelScoreAsc : function(a, b, c) {
			this.setRanking(this.rankingType.RANKING_TYPE_LEVEL_SCORE_ASC, a,
					b, c)
		},
		...
		isIosPlay68 : function() {
			return "object" === typeof window.webkit ? !0 : navigator.userAgent
					.match(/IOSplay68/i)
		},
		isIos : function() {
	...
	window.addEventListener("message", function(a) {
		var b = {
			...
			setStorage : function(a, b) {
				...
				if (1 != localStorage.getItem(f) && void 0 !== a && null !== a
						&& a) {
					for ( var d in a)
						localStorage.setItem(d, a[d]);
